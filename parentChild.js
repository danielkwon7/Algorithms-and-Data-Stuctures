...
var commonAncestors = function(array, child1, child2) {
  ...
  console.log('this is the roots', roots);
...
// parents is an object from string to array of children strings
function commonAncestors1(parentToChildren, child1, child2) {
  var parents = {};
  var roots = [];
  for (var i = 0; i < roots.length; i++) {
    var result = helper(parentToChildren, roots[i]);
    if (result[foundFirst] && result[foundSecond]) {
      return true;
    }
  }
